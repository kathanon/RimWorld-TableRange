...
namespace TableRange
{
    internal static class Strings
    {
        ...
        public static readonly string RangeToAll_title      = (PREFIX + "RangeToAll.title"     ).Translate();
        public static readonly string RangeToAll_desc       = (PREFIX + "RangeToAll.desc"      ).Translate();
